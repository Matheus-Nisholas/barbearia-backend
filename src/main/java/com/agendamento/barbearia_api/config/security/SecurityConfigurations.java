package com.agendamento.barbearia_api.config.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/agendamentos/ocupados").permitAll()
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui.html", "/swagger-ui/**").permitAll()

                        // Rotas exclusivas do ADMIN
                        .requestMatchers(HttpMethod.GET, "/api/agendamentos").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/agendamentos/faturamento").hasRole("ADMIN")
